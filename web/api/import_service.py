...
from processor.utils.task_utils import update_task_status, add_done_task, add_running_task, get_task_status, \
...
def run_graph_task(task_id: str, file_dir: str, import_file_path: str):
    ...
    try:
        ...
        for event in workflow.run(init_state,stream=True): #输出的是流式的，所以用的是for循环
