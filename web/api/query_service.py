...
from processor.utils.mongo_history_utils import get_recent_messages, clear_history
from processor.utils.sse_utils import sse_generator, create_sse_queue, push_to_session, SSEEvent
from processor.utils.task_utils import TASK_STATUS_PROCESSING, update_task_status, get_task_result, \
    TASK_STATUS_COMPLETED, TASK_STATUS_FAILED, add_done_task, clear_task
...
async def query(background_tasks: BackgroundTasks, request: QueryRequest):
    ...
    # 每次新提问，先清空该会话上一次的进度状态（done/running/status/result），重新计进度
