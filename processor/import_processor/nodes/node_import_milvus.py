...
class NodeImportMilvus(BaseNode):
    ...
    def _step_4_insert_data(self, client, chunks_json_data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        # 2. 执行批量插入
        insert_result = client.insert(collection_name=self.config.chunks_collection, data=data_to_insert)
...
if __name__ == "__main__":
    ...
    json_path = r"D:\output\H3C LA2608室内无线网关 用户手册-6W100-整本手册\state_vector.json"
